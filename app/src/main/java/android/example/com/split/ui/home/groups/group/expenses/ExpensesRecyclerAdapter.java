...
// TextView widgets
public class ExpensesRecyclerAdapter extends RecyclerView.Adapter<ExpensesRecyclerAdapter
    .ExpenseViewHolder> {
  ...
  class ExpenseViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private void editExpensePopupDialog(final Expense expense, final int position) {
      ...
      final View view = LayoutInflater.from(mAdapter.context)
                                      .inflate(R.layout.dialog_add_expense, null);

      dialogBuilder.setView(view);
      final AlertDialog dialog = dialogBuilder.create();
      //takes the already existing title and sets it to the text field
      final EditText editTitle = (EditText) view
          .findViewById(R.id.editText_dialog_add_expense_title);
