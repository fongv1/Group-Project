...
public class HomeActivity extends AppCompatActivity implements NavigationView
  ...
  private final FirebaseAuth.AuthStateListener authStateListener = new FirebaseAuth
      .AuthStateListener() {
    @Override
        ...
        repository.addGroupExpense("KGKsdM2VDKN7w3AHUokk",expOb, new Handler.Callback() {
            ...
            public boolean handleMessage(Message msg) {
                if(msg.getData().getBoolean(GroupDataRepository.SUCCESS)){
                   ...
                   // ArrayList<User> users = (ArrayList<User>) bundle.getSerializable
                   (GroupDataRepository.USERS_LIST);
  ...
  private void hideSystemUI() {
    ...
    decorView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_IMMERSIVE
                                        ...
                                        // that the
                                        // content doesn't resize when the system bars hide and
                                        // show.
